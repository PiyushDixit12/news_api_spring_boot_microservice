...
public class JwtService {
    ...
    public String generateToken(AuthRequest authRequest){
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis()+20000*60*30))
...
//        return (userName.equals(userDetails.getUsername()) && !isTokenExpired(token) &&!blackList.isBlackListed(token) && !roles.isEmpty() && (roles.contains("USER")||roles.contains("ADMIN")));
        return (userName.equals(userDetails.getUsername()) && !isTokenExpired(token) && !roles.isEmpty() && (roles.contains("USER")||roles.contains("ADMIN")));
    }
